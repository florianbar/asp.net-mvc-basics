namespace ComicBookGallery.Data
{
    ...
    public static class Data
    {
        ...
        /* Static constructor:
         * These are called just before any instances of a class is created or any static members are accessed
         * (see https://msdn.microsoft.com/en-us/library/k9x6w0hc.aspx) 
         */
        static Data()
        {
            InitData();
